...
#there were some deprecated methods...
describe ProductsController do
  ...
  context 'another user is singed in' do
    ...
    before do
      # sign_in user2 # what for if stubbed?
      stub_log_in user2
    end
    ...
    describe 'GET edit' do
      describe 'with valid params' do
        it 'redirects to product page' do
          get :edit, { id: product.to_param, product: { user_id: user2.id}, category_id: category.to_param }
  ...
  describe 'DELETE destroy' do
    ...
    context 'user is signed in and is owner of product' do
      before do
        # sign_in user # what for if stubbed?
        stub_log_in user
        product.user = user
